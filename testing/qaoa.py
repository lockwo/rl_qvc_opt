...
for it in range(rep):
    ...
    #layer1 = tfq.layers.PQC(qaoa_circuit, cost, repetitions=1000, differentiator=tfq.differentiators.ParameterShift())(ins)
    layer1 = tfq.layers.PQC(qaoa_circuit, cost, differentiator=tfq.differentiators.Adjoint())(inputs)
    vqc = tf.keras.models.Model(inputs=inputs, outputs=layer1)

    inputs = tf.keras.Input(shape=(), dtype=tf.dtypes.string)
    #layer1 = tfq.layers.PQC(qaoa_circuit, cost, repetitions=1000, differentiator=tfq.differentiators.ParameterShift())(inputs)
    layer1 = tfq.layers.PQC(qaoa_circuit, cost, differentiator=tfq.differentiators.Adjoint())(inputs)
